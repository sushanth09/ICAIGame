...
export function WelcomePage({ onContinue }: WelcomePageProps) {
  return (
    <div
      className="relative w-full min-w-0 max-w-full min-h-[100dvh] md:min-h-0 md:h-full md:overflow-hidden flex flex-col items-center justify-center px-4 py-6 md:py-0"
      style={{ zIndex: 1 }}
    >
      <BackgroundElements />
